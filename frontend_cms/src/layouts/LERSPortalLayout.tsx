...
const navigation = [
  { name: 'DASHBOARD', href: '/lers/portal/dashboard' },
  { name: 'REQUESTS', href: '/lers/portal/requests' },
]

export default function LERSPortalLayout() {
        ...
        <div className="flex h-16 items-center justify-between px-8">
          ...
          <div className="flex items-center gap-12">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg font-semibold text-gray-900">LERS</span>
            </div>
