...
export default function ProviderInProgress() {
  ...
  const allRequests = (data?.results || []).filter((r: any) => r.status === 'IN_PROGRESS');
          ...
          <Card className="border border-gray-200 shadow-sm">
            <CardContent className="p-12">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  {searchQuery ? 'Try adjusting your search' : 'Requests you\'re actively working on will appear here'}
                </p>
              </div>
            </CardContent>
          </Card>
                          ...
                          >
                            ...
                            <td className="px-4 py-3.5">
                              <div className="flex items-center gap-2">
                                ...
                                <Badge variant="outline" className="bg-amber-50 text-amber-600 border-amber-200 text-xs px-2 py-0.5">
                                  {firRequests.length} In Progress
                                </Badge>
                              </div>
                            </td>
