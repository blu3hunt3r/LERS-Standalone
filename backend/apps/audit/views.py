...
# STANDALONE: Case import and court export feature disabled
...
class AuditViewSet(viewsets.ViewSet):
    ...
    STANDALONE MODE: Court export features disabled (case management dependency)
    """
    permission_classes = [IsAuthenticated]

    # DISABLED FOR STANDALONE: Court export requires case management
